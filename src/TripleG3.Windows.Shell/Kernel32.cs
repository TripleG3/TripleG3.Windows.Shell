...
/// documented as forwarding to lower-level Windows modules. This wrapper discovers the exports available on the
/// current machine at runtime and lets callers bind the exact delegate signature they need with
...
public static class Kernel32
{
    ...
    private static readonly NativeModule s_module = new(LibraryName, typeof(Kernel32));
