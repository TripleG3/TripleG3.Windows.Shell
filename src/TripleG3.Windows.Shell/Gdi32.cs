...
/// undocumented. This wrapper discovers the exports available on the current machine at runtime and lets callers
/// bind the exact delegate signature they need with <see cref="GetFunction{TDelegate}(string)" /> or
...
public static class Gdi32
{
    ...
    private static readonly NativeModule s_module = new(LibraryName, typeof(Gdi32));
